<script>
var ajaxBookedDates = <?= json_encode(url('/api/booked-dates'), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT) ?>;
var ajaxCreateBooking = <?= json_encode(url('/api/booking/create'), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT) ?>;
var ajaxBookingPricePreview = <?= json_encode(url('/api/booking/price-preview'), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT) ?>;
